...
const vfs_filename_t daplink_url_name =       "UBIRCH  HTM";
__attribute__((aligned(4)))
const vfs_filename_t daplink_drive_name =     "UBIRCH     ";
__attribute__((aligned(4)))
const char *const daplink_target_url = "https://ubirch.com/board/@B";
